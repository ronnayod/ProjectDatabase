                ...
                <div class="container">
                    <div class="row">
                        ...
                        <?php
                            // LOAD CAT DATA
                            $ct = $_GET['ct'];
                            $sql = "select * from categories where cat_id='$ct'";
                            $load = $con->query($sql);
                            if($rs = $load->fetch_assoc()):
                        ?>
                        <div class="mb-3 col-lg-4">
                            <input type="text" name="ct" value="<?php echo $rs['cat_id'] ?>" readonly class="form-control">
                        </div>
                        <div class="mb-3 col-lg-4">
                            <input type="text" name="cat_name" value="<?php echo $rs['cat_name'] ?>" class="form-control">
                        </div>
                        <?php
                        endif;
                        ?>
